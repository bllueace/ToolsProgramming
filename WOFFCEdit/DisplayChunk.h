...
public:
	...
	void UpdateTerrain(Vector3 rOrigin, Vector3 rDirection);			//updates the geometry based on the heigtmap
	Vector3 updateObjectHeight(Vector3 originm, Vector3 direction);
	bool RayIntersectsTriangle(Vector3 rayOrigin,Vector3 rayVector,Vector3 v0, Vector3 v1, Vector3 v2,Vector3& outIntersectionPoint);
	//Vector3 getPickedPos();
	Vector3 pick;
	Vector3 col;
	...
	ID3D11ShaderResourceView *					m_texture_paint_01;				//paint texture
