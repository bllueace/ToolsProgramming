...
BEGIN_MESSAGE_MAP(MFCMain, CWinApp)
	...
	ON_COMMAND(ID_BUTTON40008, &MFCMain::ToolBarButton2)
	ON_COMMAND(ID_BUTTON40016, &MFCMain::ToolBarButton3)
	ON_COMMAND(ID_BUTTON40009, &MFCMain::ToolBarButton4)
	ON_COMMAND(ID_BUTTON40015, &MFCMain::ToolBarButton5)
	ON_COMMAND(ID_BUTTON40018, &MFCMain::ToolBarButton6)
...
BOOL MFCMain::InitInstance()
{
	...
	m_frame->Create(	NULL,
					_T("World Of Flimidy-Flamidy Craft Editor"),
					WS_OVERLAPPEDWINDOW,
...
{
	m_ToolSystem.onActionSculpting();
}

void MFCMain::ToolBarButton4()
{
	m_ToolSystem.onActionRotate();
}
